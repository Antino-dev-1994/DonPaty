...
import { ArchiveRestore, BadgeDollarSign, BarChart3, Boxes, Calculator, CircleDollarSign, ClipboardCheck, CookingPot, Factory, Flag, House, LayoutDashboard, PackageOpen, ReceiptText, ScrollText, ShieldCheck, ShoppingBag, ShoppingCart, UserRoundCheck, UsersRound } from '@lucide/vue';
...
const mainNavItems = computed<NavItem[]>(() => [
    ...
    ...(hasPermission('settings.manage') ? [{ title: 'Puesta en marcha', href: '/launch', icon: Flag }] : []),
