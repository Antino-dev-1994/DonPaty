...
#[Fillable(['document_number', 'financial_category_id', 'person_id', 'cost_period_id', 'cost_pool_entry_id', 'effective_at', 'due_at', 'description', 'total_amount', 'paid_amount', 'balance_amount', 'status', 'journal_entry_id', 'created_by'])]
class ExpenseRecord extends Model
{
    ...
    public function costPoolEntry(): BelongsTo { return $this->belongsTo(CostPoolEntry::class); }
    public function journalEntry(): BelongsTo { return $this->belongsTo(JournalEntry::class); }
    public function creator(): BelongsTo { return $this->belongsTo(User::class, 'created_by'); }
    public function payable(): MorphOne { return $this->morphOne(Payable::class, 'source'); }
