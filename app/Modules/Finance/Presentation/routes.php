...
use App\Modules\Finance\Presentation\Http\Controllers\CreateBusinessOpeningController;
...
use App\Modules\Finance\Presentation\Http\Controllers\StoreBusinessOpeningController;
...
Route::middleware(['web', 'auth', 'verified'])->prefix('finance')->name('finance.')->group(function (): void {
    ...
    Route::get('/opening/create', CreateBusinessOpeningController::class)->name('opening.create');
    Route::post('/opening', StoreBusinessOpeningController::class)->name('opening.store');
