...
Route::middleware(['web','auth','verified'])->prefix('customers')->name('customers.')->group(function (): void {
    Route::get('/', ListCustomersController::class)->name('index'); Route::get('/create', CreateCustomerController::class)->name('create'); Route::post('/', StoreCustomerController::class)->name('store'); Route::get('/{customer}/edit', EditCustomerController::class)->name('edit'); Route::put('/{customer}', UpdateCustomerController::class)->name('update');
});
